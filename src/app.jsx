    ...
    <StrictMode>
        ...
        <div className="footer">
            <span className="links">
                <a className="icon icon-help-question" href="https://github.com/zuev93/calculator_miro"
                   target="_blank"></a>
                <a className="icon icon-comment-feedback" href="https://github.com/zuev93/calculator_miro/issues"
                   target="_blank"></a>
            </span>
            <span>v0.2</span>
        </div>
